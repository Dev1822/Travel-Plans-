...
export const DestinationDetailPage = () => {
  ...
  return (
    <div className="bg-[#FCF9F8] text-[#1C1B1B] min-h-screen">
      ...
      <section className="relative h-[88vh] min-h-[620px] w-full flex items-end pb-16 px-4 sm:px-8 lg:px-16">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto text-white space-y-4">
          ...
          <h1 className="font-serif text-4xl sm:text-7xl font-bold leading-tight">
            {name}
          </h1>
          <p className="text-sm sm:text-lg text-white/90 max-w-2xl font-normal leading-relaxed">
            {tagline}
          </p>
          ...
          <div className="pt-4">
            <button
              ...
              className="bg-[#FCF9F8] text-[#1C1B1B] px-8 py-4 text-xs font-semibold uppercase tracking-[0.15em] rounded hover:bg-[#F0EDED] hover:-translate-y-0.5 transition-all shadow-md cursor-pointer"
            >
              Plan This Journey
            </button>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-24 sm:py-32">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-16 items-center">
          <div className="md:col-span-7 image-container overflow-hidden rounded relative h-[420px] sm:h-[500px] shadow-md bg-[#F0EDED]">
            <img
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left divide-y md:divide-y-0 md:divide-x divide-[#DAC2B6]/30">
            <div className="px-6 first:pt-0 pt-6 md:pt-0 flex flex-col items-center md:items-start">
              <span className="text-[11px] font-semibold text-[#877369] uppercase tracking-widest mb-1.5">
                Best Season
              </span>
      ...
      {/* ── 4. KEY LANDMARKS ASYMMETRICAL GRID ── */}
      <section className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-24 sm:py-32 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="md:col-span-8 group cursor-pointer relative h-[480px] overflow-hidden rounded bg-[#1C1B1B] image-zoom shadow-md">
            <img
            ...
            />
            <div className="absolute inset-0 scrim-bottom" />
            <div className="absolute bottom-0 left-0 p-8 text-white space-y-1.5">
              <h3 className="font-serif text-3xl sm:text-4xl font-bold">
                City Palace
              </h3>
              <p className="text-xs sm:text-sm text-[#FCF9F8]/90 max-w-md leading-relaxed">
          ...
          <div className="md:col-span-4 group cursor-pointer relative h-[480px] overflow-hidden rounded bg-[#1C1B1B] image-zoom shadow-md">
            <img
            ...
            <div className="absolute bottom-0 left-0 p-8 text-white space-y-1.5">
              ...
              <p className="text-xs text-[#FCF9F8]/90 leading-relaxed">
          ...
          <div className="md:col-span-6 group cursor-pointer relative h-[380px] overflow-hidden rounded bg-[#1C1B1B] image-zoom shadow-md">
            <img
            ...
            />
            <div className="absolute inset-0 scrim-bottom" />
            <div className="absolute bottom-0 left-0 p-6 sm:p-8 text-white space-y-1">
              <h3 className="font-serif text-2xl sm:text-3xl font-bold">
                Sajjangarh Palace
              </h3>
              <p className="text-xs text-[#FCF9F8]/90 leading-relaxed">
                The Monsoon Palace, offering panoramic sunset views across the
                Aravalli peaks.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#F6F3F2] py-24 sm:py-32 px-4 sm:px-8 border-t border-[#DAC2B6]/30 text-center">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-xs sm:text-sm text-[#54433A] leading-relaxed">
            Discover the romantic heritage of {name} with an actionable,
          ...
          <div className="pt-2">
            <button
              type="button"
              onClick={handlePlanClick}
              className="bg-[#1C1B1B] text-white px-10 py-4 text-xs font-semibold uppercase tracking-[0.15em] rounded hover:bg-[#6C2F00] transition-colors shadow-md cursor-pointer"
            >
              Plan This Journey
            </button>
          </div>
